...
class CssLinksMetaConfiguration extends CustomizableClass
{
    /**
    ...
    public function get(): array
    {
        ...
        return [
            ...
            "admin->{$cManageInvoices}->" . Constants\AdminRoute::AMI_MULTIPLEPRINT => [
                $type => Constants\Type::T_ARRAY,
            ],
            "admin->{$cManageInvoices}->" . Constants\AdminRoute::AMI_PRINT => [
                $type => Constants\Type::T_ARRAY,
            ],
...
//            "admin->{$cManageStackedTaxInvoice}->" . Constants\AdminRoute::AMSTI_MULTIPLEPRINT => [
//                $type => Constants\Type::T_ARRAY,
//            ],
//            "admin->{$cManageStackedTaxInvoice}->" . Constants\AdminRoute::AMSTI_PRINT => [
//                $type => Constants\Type::T_ARRAY,
//            ],
            ...
            "admin->{$cManageReports}->" . Constants\AdminRoute::AMR_CUSTOM_LOTS_PRINT => [
                $type => Constants\Type::T_ARRAY,
            ],
            ...
            "admin->{$cManageUsers}->" . Constants\AdminRoute::AMU_VIEW => [
                $type => Constants\Type::T_ARRAY,
            ],
            ...
            "m->{$cResponsiveMyInvoices}->" . Constants\ResponsiveRoute::AINV_PRINT => [
                $type => Constants\Type::T_ARRAY,
            ],
