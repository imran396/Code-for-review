...
/**
 * Class TypePlaceholderRenderer
 * @package Sam\Sms\Template\Placeholder\Auction\Internal\Render
 * @internal
 */
class TypePlaceholderRenderer extends CustomizableClass implements PlaceholderRendererInterface
{
    /**
