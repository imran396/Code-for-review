...
/**
 * Class AskingBidPlaceholderRenderer
 * @package Sam\Sms\Template\Placeholder\AuctionLot\Internal\Render
 * @internal
 */
class AskingBidPlaceholderRenderer extends CustomizableClass implements PlaceholderRendererInterface
{
    ...
    {
        return [PlaceholderKey::ASKING_BID];
    }
    ...
    public function render(SmsTemplatePlaceholder $placeholder, AuctionLotItem $auctionLot): string
    {
        ...
        return (string)$this->getDataProvider()->loadAskingBidAmount($auctionLot->Id, true);
    }
}
