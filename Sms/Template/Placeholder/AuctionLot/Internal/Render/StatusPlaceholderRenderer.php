...
/**
 * Class StatusPlaceholderRenderer
 * @package Sam\Sms\Template\Placeholder\AuctionLot\Internal\Render
 * @internal
 */
class StatusPlaceholderRenderer extends CustomizableClass implements PlaceholderRendererInterface
{
    ...
    public function render(SmsTemplatePlaceholder $placeholder, AuctionLotItem $auctionLot): string
    {
        ...
        return LotPureRenderer::new()->makeLotStatus($auctionLot->LotStatusId, $auction->Reverse ?? false);
    }
}
