...
namespace Sam\Reminder\Concrete\Pickup\Internal\Process;
...
use Sam\Reminder\Concrete\Pickup\Internal\Load\DataProviderCreateTrait;
...
class Processor extends CustomizableClass
{
    ...
    public function process(ProcessingInput $input): ProcessingResult
    {
        ...
        $templateName = Constants\EmailKey::PICKUP_REMINDER;
    ...
    protected function createReminder(
        ...
        if (!$invoiceBidderUser) {
            log_error(
                "Available invoice winning user not found, when creating pickup reminder"
