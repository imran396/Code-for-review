 ...
 * @package ${NAMESPACE}
 */
class SettlementLotCustomFieldRenderer extends CustomizableClass
{
    ...
    protected function getLotCustomFieldData(LotItemCustField $lotCustomField, int $lotItemId): string|int|null
    {
        ...
        if (
            ...
            if (
                ...
                $customFieldData = '<img src="' . $url . '" alt="' . htmlentities($lotCustomData->Text) . '" title="" />';
            } else {
                $customFieldData = $lotCustomData->Text;
            }
        }
