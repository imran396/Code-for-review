...
class SingleSettlementCheckClearedMarkingValidationResult extends CustomizableClass
{
    ...
    public function hasNotPostedError(): bool
    {
        return $this->getResultStatusCollector()->hasConcreteError([self::ERR_NOT_POSTED_YET]);
    }

    public function hasAlreadyClearedError(): bool
    {
        return $this->getResultStatusCollector()->hasConcreteError([self::ERR_ALREADY_CLEARED_ON]);
    }
