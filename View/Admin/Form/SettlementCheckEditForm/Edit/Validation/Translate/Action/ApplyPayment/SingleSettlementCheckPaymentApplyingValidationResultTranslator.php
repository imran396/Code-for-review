...
namespace Sam\View\Admin\Form\SettlementCheckEditForm\Edit\Validation\Translate\Action\ApplyPayment;
...
/**
 * Class SingleSettlementCheckPaymentApplyingValidationResultTranslator
 * @package Sam\Settlement\Check\Action\ApplyPayment
 */
class SingleSettlementCheckPaymentApplyingValidationResultTranslator extends CustomizableClass
{
    ...
    protected function buildErrorTranslationCollection(): void
    {
        ...
        $domain = 'admin_single_settlement_check_payment_applying_validator';
        $this->errorTranslations = [
            ...
            Result::ERR_ALREADY_PAYMENT_APPLIED => $tr->trans('error.already_payment_applied', [], $domain, $this->language),
            Result::ERR_ALREADY_VOIDED => $tr->trans('error.already_voided', [], $domain, $this->language),
        ];
    }
}
