...
namespace Sam\View\Admin\Form\InvoiceItemForm\ShippingInfo\Edit\Save;

use Sam\Storage\WriteRepository\Entity\InvoiceUserShipping\InvoiceUserShippingWriteRepositoryAwareTrait;
use Sam\View\Admin\Form\InvoiceItemForm\ShippingInfo\Edit\Common\InvoiceItemFormShippingInfoEditingInput;
use Sam\Core\Address\Validate\AddressChecker;
use Sam\Core\Service\CustomizableClass;
use Sam\Invoice\Common\Bidder\Load\InvoiceUserLoaderAwareTrait;

class InvoiceItemFormShippingInfoEditingUpdater extends CustomizableClass
{
    ...
    /**
     * @param InvoiceItemFormShippingInfoEditingInput $input
     * @param bool $isReadOnlyDb
     * @return void
     */
    public function update(
        InvoiceItemFormShippingInfoEditingInput $input,
