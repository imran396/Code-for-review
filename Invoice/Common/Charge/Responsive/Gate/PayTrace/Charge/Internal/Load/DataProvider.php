...
namespace Sam\Invoice\Common\Charge\Responsive\Gate\PayTrace\Charge\Internal\Load;
...
class DataProvider extends CustomizableClass
{
    ...
    public function loadInvoicedAuctionDtos(int $invoiceId): array
    {
        return InvoiceItemLoader::new()->loadInvoicedAuctionDtos($invoiceId);
    }
