...
namespace Sam\Invoice\StackedTax\Generate\Produce\Internal\ShippingCharge;
 ...
 * @package Sam\Invoice\StackedTax\Generate\Produce\Internal\ShippingCharge
 */
class ShippingChargeProducer extends CustomizableClass
{
    ...
    {
        $amount = $this->getSettingsManager()->get(Constants\Setting::SHIPPING_CHARGE, $invoice->AccountId);
        if ($amount) {
