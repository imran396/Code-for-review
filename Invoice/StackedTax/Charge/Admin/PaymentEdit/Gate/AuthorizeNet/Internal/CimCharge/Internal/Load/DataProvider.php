...
namespace Sam\Invoice\StackedTax\Charge\Admin\PaymentEdit\Gate\AuthorizeNet\Internal\CimCharge\Internal\Load;
...
class DataProvider extends CustomizableClass
{
    ...
    public function createAuthNetCimManager(int $accountId): Payment_AuthorizeNetCim
    {
        return new Payment_AuthorizeNetCim($accountId);
    }
}
