...
namespace Sam\Invoice\Legacy\Charge\Admin\InvoiceEdit\Gate\Opayo\Internal\Update;
...
use Sam\Invoice\Legacy\Charge\Admin\InvoiceEdit\Gate\Opayo\Internal\Update\Internal\Load\DataProviderCreateTrait;
use Sam\Invoice\Legacy\Charge\Admin\InvoiceEdit\Gate\Opayo\Internal\Update\AdminInvoiceEditOpayoCcInfoUpdaterResult as Result;
...
class AdminInvoiceEditOpayoCcInfoUpdater extends CustomizableClass
{
    ...
    protected function updateCim(
        ...
        $errorMessage = $this->createAdminInvoiceEditChargingHelper()->updateCimInfo(
            $params,
            $invoice,
            $user,
            $editorUserId
