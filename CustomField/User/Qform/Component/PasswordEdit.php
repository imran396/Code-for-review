...
/**
 * Password-type custom user field editing component
 *
 ...
 *
 * @method BaseEdit|PasswordEdit getBaseComponent()
 */
 ...
 */
class PasswordEdit extends BaseEdit
{
    protected int $type = Constants\CustomField::TYPE_PASSWORD;
