...
/**
 * Fulltext-type custom user field editing component
 *
 ...
 *
 * @method BaseEdit|FulltextEdit getBaseComponent()
 */
 ...
 */
class FulltextEdit extends BaseEdit
{
    protected int $type = Constants\CustomField::TYPE_FULLTEXT;
