...
/**
 * Text-type custom user field editing component
 *
 ...
 *
 * @method BaseEdit|TextEdit getBaseComponent()
 */
 ...
 */
class TextEdit extends BaseEdit
{
    protected int $type = Constants\CustomField::TYPE_TEXT;
