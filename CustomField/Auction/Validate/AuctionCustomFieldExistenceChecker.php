...
/**
 * Class AuctionCustomFieldExistenceChecker
 * @package Sam\CustomField\Auction\Validate
 */
class AuctionCustomFieldExistenceChecker extends CustomizableClass
{
    ...
    {
        $isFound = $this->createAuctionCustFieldReadRepository()
    ...
    {
        $count = $this->createAuctionCustFieldReadRepository()
            ->enableReadOnlyDb($isReadOnlyDb)
            ->filterActive(true)
            ->count();
        return $count;
