...
namespace Sam\EntityMaker\AuctionLot\Validate\Internal\TaxSchema\Internal\TaxCountry\Internal\Load;
...
/**
 * Class DataProvider
 * @package Sam\EntityMaker\AuctionLot\Validate\Internal\TaxSchema\Detect\Internal\Load
 */
class DataProvider extends CustomizableClass
{
    ...
    public function loadLotItemTaxCountry(?int $lotItem, bool $isReadOnlyDb = false): string
    {
        return $this->getLotItemLoader()->load($lotItem, $isReadOnlyDb)?->TaxDefaultCountry ?? '';
    }
