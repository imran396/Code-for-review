...
use Sam\EntityMaker\Auction\Validate\Internal\TaxSchema\Internal\Validate\AuctionTaxSchemaValidationResult as Result;

class AuctionTaxSchemaValidator extends CustomizableClass
{
    ...
    ): Result
    {
        ...
        if (!$hasTaxSchema) {
            if ($amountSource === Constants\StackedTax::AS_HAMMER_PRICE) {
                ...
                $result->addError(Result::ERR_SERVICES_TAX_SCHEMA_ID_INVALID);
            }
            return $result;
        }
        ...
        if (
            ...
            if ($amountSource === Constants\StackedTax::AS_HAMMER_PRICE) {
                ...
                $result->addError(Result::ERR_SERVICES_TAX_SCHEMA_COUNTRY_MISMATCH);
            }
            return $result;
        }
