...
class AuctionTaxSchemaValidationResult extends CustomizableClass
{
    ...
    public const ERR_SERVICES_TAX_SCHEMA_ID_INVALID = 5;
    public const ERR_SERVICES_TAX_SCHEMA_COUNTRY_MISMATCH = 6;
    ...
    protected const ERROR_MESSAGES = [
        ...
        self::ERR_SERVICES_TAX_SCHEMA_ID_INVALID => 'Services Tax Schema ID is invalid',
        self::ERR_SERVICES_TAX_SCHEMA_COUNTRY_MISMATCH => 'Services Tax Schema Country mismatch',
    ];
