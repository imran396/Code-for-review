...
/**
 * Class TimedDateValidationResult
 * @package Sam\EntityMaker\Auction\Validate\Internal\Date\Internal\Validate\Timed
 */
class TimedDateValidationResult extends CustomizableClass implements ErrorContainerInterface
{
    use ResultStatusCollectorAwareTrait;

    public const ERR_START_BIDDING_DATE_REQUIRED = 1;
    public const ERR_START_CLOSING_DATE_REQUIRED = 2;
    public const ERR_START_CLOSING_DATE_INVALID = 3;
    public const ERR_START_CLOSING_DATE_DO_NOT_MATCH_ITEMS_DATE = 4;
    public const ERR_START_BIDDING_DATE_DO_NOT_MATCH_ITEMS_DATE = 5;

    public const ERROR_MESSAGES = [
        self::ERR_START_BIDDING_DATE_REQUIRED => 'Required',
        self::ERR_START_CLOSING_DATE_REQUIRED => 'Required',
        self::ERR_START_CLOSING_DATE_INVALID => 'Invalid',
        self::ERR_START_CLOSING_DATE_DO_NOT_MATCH_ITEMS_DATE => 'Auction\'s and items start closing date don\'t match. Please select another option',
        self::ERR_START_BIDDING_DATE_DO_NOT_MATCH_ITEMS_DATE => 'Auction\'s and items start bidding date don\'t match. Please select another option',
    ];
