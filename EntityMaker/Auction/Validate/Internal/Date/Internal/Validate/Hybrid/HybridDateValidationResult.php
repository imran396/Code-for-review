...
/**
 * Class HybridDateValidationResult
 * @package Sam\EntityMaker\Auction\Validate\Internal\Date\Internal\Hybrid
 */
class HybridDateValidationResult extends CustomizableClass implements ErrorContainerInterface
{
    ...
    public const ERR_BIDDING_CONSOLE_ACCESS_DATE_LATER_START_CLOSING_DATE = 5;
    public const ERR_END_PREBIDDING_DATE_INVALID = 6;
    ...
    public const ERROR_MESSAGES = [
        ...
        self::ERR_BIDDING_CONSOLE_ACCESS_DATE_LATER_START_CLOSING_DATE => 'Should be earlier than Start closing date',
