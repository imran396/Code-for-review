 ...
 */
class LotItemMakerDtoFactory extends CustomizableClass
{
    /**
     ...
     * @return array [LotItemMakerInputDto, LotItemMakerConfigDto]
     */
    public function createDtos(
        ...
        $inputDto = LotItemMakerInputDto::new();
        $configDto = LotItemMakerConfigDto::new()->construct(
            $mode,
            $editorUserId,
            $serviceAccountId,
            $systemAccountId
