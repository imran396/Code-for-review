...
use Sam\EntityMaker\LotItem\Validate\Internal\TaxSchema\Internal\TaxCountry\Internal\Load\DataProviderCreateTrait;

class LotItemTaxCountryDetector extends CustomizableClass
{
    ...
    /**
     * @param string|null $lotItemTaxDefaultCountryFromInput null means not set in input, '' empty means set "none".
