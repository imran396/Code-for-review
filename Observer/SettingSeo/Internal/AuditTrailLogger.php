...
namespace Sam\Observer\SettingSeo\Internal;
 ...
 * @package Sam\Observer\SettingSeo\Internal
 */
    ...
    implements EntityCreationObserverHandlerInterface, EntityUpdateObserverHandlerInterface
{
    ...
    protected function log(EntityObserverSubject $subject): void
    {
        ...
        if ($message !== '') {
            ...
            $message = 'System Parameters (' . $settingSeo->AccountId . ') modified: ' . $message;
            $editorUserId = $this->getUserLoader()->loadSystemUserId();
            $this->getAuditTrailLogger()
                ->setAccountId($settingSeo->AccountId)
                ->setEditorUserId($editorUserId)
                ->setEvent($message)
                ->setSection($section)
                ->setUserId($settingSeo->ModifiedBy)
                ->log();
        }
    }
}
