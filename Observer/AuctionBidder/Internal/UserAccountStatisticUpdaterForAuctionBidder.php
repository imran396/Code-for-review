 ...
 * @internal
 */
class UserAccountStatisticUpdaterForAuctionBidder extends CustomizableClass
    implements EntityCreationObserverHandlerInterface, EntityUpdateObserverHandlerInterface
{
    ...
    protected function update(EntityObserverSubject $subject): void
    {
        ...
        $auction = $this->getAuctionLoader()->clear()->load($auctionBidder->AuctionId);
        $this->getUserAccountStatisticProducer()->markExpired($auctionBidder->UserId, $auction->AccountId ?? null);
    }
}
