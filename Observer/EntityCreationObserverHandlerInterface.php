...
/**
 * Interface EntityCreationObserverHandlerInterface
 * @package Sam\Observer
 */
interface EntityCreationObserverHandlerInterface extends CustomizableClassInterface
{
    /**
     * Run on entity creation if the handler is applicable
     *
