 ...
 * @internal
 */
class UserAccountStatisticUpdaterForUserWatchlist extends CustomizableClass
    implements EntityCreationObserverHandlerInterface, EntityUpdateObserverHandlerInterface
{
    ...
    protected function update(EntityObserverSubject $subject): void
    {
        ...
        $auction = $this->getAuctionLoader()->clear()->load($userWatchlist->AuctionId);
        $this->getUserAccountStatisticProducer()->markExpired($userWatchlist->UserId, $auction->AccountId ?? null);
    }
}
