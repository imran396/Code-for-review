...
/**
 * Class that contains all user import options
 *
 * Class UserImportCsvOption
 * @package Sam\Application\Controller\Admin\CsvImport\Options
 */
class UserImportCsvOption extends CustomizableClass implements ImportCsvOptionInterface
{
    /**
     * @var string
     */
    ...
    public function construct(string $encoding, bool $clearEmptyFields): static
    {
