...
/**
 * Class that contains all bid increment import options
 *
 * Class BidIncrementImportCsvOption
 * @package Sam\Application\Controller\Admin\CsvImport\Options
 */
class BidIncrementImportCsvOption extends CustomizableClass implements ImportCsvOptionInterface
{
    /**
     * @var string
     */
    ...
    public function construct(string $auctionType): static
    {
    ...
    public function fromRequest(RequestParamFetcher $paramFetcher): static
    {
        return $this->construct(
            $paramFetcher->getString('auctionType')
        );
    }
}
