...
use Sam\Application\Controller\Admin\Invoice\Validate\Internal\Load\DataProviderCreateTrait;
use Sam\Core\Constants;
use Sam\Core\Service\CustomizableClass;
use Sam\Core\Data\TypeCast\ArrayCast;
use Sam\Core\Service\Optional\OptionalKeyConstants;
use Sam\Core\Service\Optional\OptionalsTrait;
use Sam\Application\Controller\Admin\Invoice\Validate\InvoiceControllerValidationResult as Result;
...
class InvoiceControllerValidator extends CustomizableClass
{
    ...
    private array $invoiceAbsentActions = [
        Constants\AdminRoute::AMI_INDEX,
        Constants\AdminRoute::AMI_GENERATE,
    ];
     ...
     */
    public function validate(?int $invoiceId, string $auctionName, int $systemAccountId, ?int $editorUserId): InvoiceControllerValidationResult
    {
     ...
     * @param int $systemAccountId
     * @param int|null $invoiceId
     * @param InvoiceControllerValidationResult $validationResult
     * @return InvoiceControllerValidationResult
     */
    protected function validateConcreteInvoice(int $systemAccountId, ?int $invoiceId, Result $validationResult): InvoiceControllerValidationResult
    {
