...
/**
 * Class ResponsiveBiddingHistoryUrlConfig
 * @package Sam\Application\Url\Build\Config
 */
class ResponsiveBiddingHistoryUrlConfig extends AbstractUrlConfig
{
    protected ?int $urlType = Constants\Url::P_AUCTIONS_BIDDING_HISTORY;
