...
/**
 * Class ResponsiveTellFriendUrlConfig
 * @package Sam\Application\Url\Build\Config
 */
class ResponsiveTellFriendUrlConfig extends AbstractUrlConfig
{
    protected ?int $urlType = Constants\Url::P_AUCTIONS_TELL_FRIEND;
