...
/**
 * Class ResponsiveAbsenteeBidsUrlConfig
 * @package Sam\Application\Url\Build\Config
 */
class ResponsiveAbsenteeBidsUrlConfig extends AbstractUrlConfig
{
    protected ?int $urlType = Constants\Url::P_AUCTIONS_ABSENTEE_BIDS;
