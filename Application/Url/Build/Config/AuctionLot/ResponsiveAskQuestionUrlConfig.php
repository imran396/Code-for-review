...
/**
 * Class ResponsiveAskQuestionUrlConfig
 * @package Sam\Application\Url\Build\Config
 */
class ResponsiveAskQuestionUrlConfig extends AbstractUrlConfig
{
    protected ?int $urlType = Constants\Url::P_AUCTIONS_ASK_QUESTION;
