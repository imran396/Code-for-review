<?php
/**
 * Url config immutable VO for configuring page header image url rendering.
 *
...
/**
 * Class HeaderImageUrlConfig
 * @package Sam\Application\Url
 */
class HeaderImageUrlConfig extends AbstractAccountDependentImageUrlConfig
{
    protected ?int $urlType = Constants\Url::I_HEADER;
