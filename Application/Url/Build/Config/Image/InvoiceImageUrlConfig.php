<?php
/**
 * Url config immutable VO for configuring invoice image url rendering.
 *
...
/**
 * Class InvoiceImageUrlConfig
 * @package Sam\Application\Url
 */
class InvoiceImageUrlConfig extends AbstractAccountDependentImageUrlConfig
{
    protected ?int $urlType = Constants\Url::I_INVOICE;
