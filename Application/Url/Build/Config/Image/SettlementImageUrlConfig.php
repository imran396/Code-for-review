<?php
/**
 * Url config immutable VO for configuring settlement image url rendering.
 *
 ...
 */
class SettlementImageUrlConfig extends AbstractAccountDependentImageUrlConfig
{
    protected ?int $urlType = Constants\Url::I_SETTLEMENT;
