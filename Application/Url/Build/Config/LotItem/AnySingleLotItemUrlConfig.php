...
namespace Sam\Application\Url\Build\Config\LotItem;

use Sam\Application\Url\Build\Config\Base\AbstractUrlConfig;
use Sam\Application\Url\Build\Config\Base\UrlConfigConstants;

/**
 * Class AnySingleLotItemUrlConfig
 * @package Sam\Application\Url\Build\Config\AuctionLot
 */
class AnySingleLotItemUrlConfig extends AbstractUrlConfig
{
    /**
     ...
     * @return static
     */
    public function construct(int $urlType, ?int $lotItemId, array $options = []): static
    {
        $options[UrlConfigConstants::URL_TYPE] = $urlType;
        $options[UrlConfigConstants::PARAMS] = [$lotItemId];
     ...
     * @return static
     */
    public function forWeb(int $urlType, ?int $lotItemId, array $options = []): static
    {
        $options = $this->toWebViewOptions($options);
        return $this->construct($urlType, $lotItemId, $options);
    }
     ...
     * @return static
     */
    public function forRedirect(int $urlType, ?int $lotItemId, array $options = []): static
    {
     ...
     * @return static
     */
    public function forDomainRule(int $urlType, ?int $lotItemId, array $options = []): static
    {
     ...
     * @return static
     */
    public function forBackPage(int $urlType, ?int $lotItemId, array $options = []): static
    {
