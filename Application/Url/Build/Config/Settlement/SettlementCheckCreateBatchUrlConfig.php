...
/**
 * Config object for settlement checks batch creation page url
 *
 * Class SettlementCheckCreateBatchUrlConfig
 * @package Sam\Application\Url\Build\Config\Settlement
 */
class SettlementCheckCreateBatchUrlConfig extends AbstractUrlConfig
{
    protected ?int $urlType = Constants\Url::A_MANAGE_SETTLEMENT_CHECK_CREATE_BATCH;
