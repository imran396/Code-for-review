 ...
 */
class TwoStringParamUrlConfig extends AbstractUrlConfig
{
    /**
     ...
     * @return static
     */
    public function construct(int $urlType, ?string $param1, ?string $param2, array $options = []): static
    {
        $options[UrlConfigConstants::URL_TYPE] = $urlType;
        $options[UrlConfigConstants::PARAMS] = [$param1, $param2];
     ...
     * @return static
     */
    public function forWeb(int $urlType, ?string $param1, ?string $param2, array $options = []): static
    {
        $options = $this->toWebViewOptions($options);
        return $this->construct($urlType, $param1, $param2, $options);
    }
     ...
     * @return static
     */
    public function forRedirect(int $urlType, ?string $param1, ?string $param2, array $options = []): static
    {
     ...
     * @return static
     */
    public function forDomainRule(int $urlType, ?string $param1, ?string $param2, array $options = []): static
    {
     ...
     * @return static
     */
    public function forBackPage(int $urlType, ?string $param1, ?string $param2, array $options = []): static
    {
