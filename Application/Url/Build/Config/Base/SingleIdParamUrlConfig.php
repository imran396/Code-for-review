 ...
 */
class SingleIdParamUrlConfig extends AbstractUrlConfig
{
    /**
     ...
     * @return static
     */
    public function construct(int $urlType, ?int $id, array $options = []): static
    {
        $options[UrlConfigConstants::URL_TYPE] = $urlType;
        $options[UrlConfigConstants::PARAMS] = [$id];
     ...
     * @return static
     */
    public function forWeb(int $urlType, ?int $id, array $options = []): static
    {
        $options = $this->toWebViewOptions($options);
        return $this->construct($urlType, $id, $options);
    }
     ...
     * @return static
     */
    public function forRedirect(int $urlType, ?int $id, array $options = []): static
    {
     ...
     * @return static
     */
    public function forDomainRule(int $urlType, ?int $id, array $options = []): static
    {
     ...
     * @return static
     */
    public function forBackPage(int $urlType, ?int $id, array $options = []): static
    {
