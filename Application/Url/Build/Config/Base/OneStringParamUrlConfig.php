 ...
 */
class OneStringParamUrlConfig extends AbstractUrlConfig
{
    /**
     ...
     * @return static
     */
    public function construct(int $urlType, ?string $param1, array $options = []): static
    {
     ...
     * @return static
     */
    public function forWeb(int $urlType, ?string $param1, array $options = []): static
    {
     ...
     * @return static
     */
    public function forRedirect(int $urlType, ?string $param1, array $options = []): static
    {
     ...
     * @return static
     */
    public function forDomainRule(int $urlType, ?string $param1, array $options = []): static
    {
     ...
     * @return static
     */
    public function forBackPage(int $urlType, ?string $param1, array $options = []): static
    {
