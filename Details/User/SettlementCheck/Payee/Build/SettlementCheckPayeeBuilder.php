...
use Sam\Details\User\SettlementCheck\Payee\Build\Internal\Load\DataProvider;
use Sam\Details\User\SettlementCheck\Payee\Build\Internal\Render\TemplateParser;
use Sam\Details\User\SettlementCheck\Payee\Internal\ConfigManager;
use Sam\Settings\SettingsManagerAwareTrait;

/**
 * Class SettlementCheckPayeeBuilder
 * @package Sam\Details\User\SettlementCheck\Payee\Build
 * @method ConfigManager getConfigManager()
 */
class SettlementCheckPayeeBuilder extends \Sam\Details\Core\Builder
{
    ...
    public function construct(int $userId, int $accountId, bool $isReadOnlyDb = false): static
    {
        ...
        $this->template = (string)$this->getSettingsManager()->get(Constants\Setting::STLM_CHECK_PAYEE_TEMPLATE, $accountId);
