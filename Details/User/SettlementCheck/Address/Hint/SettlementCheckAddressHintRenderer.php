...
use Sam\Details\User\SettlementCheck\Address\Internal\Config\ConfigManagerCreateTrait;

/**
 * Class SettlementCheckAddressHintRenderer
 * @package Sam\Details\User\SettlementCheck\Address\Hint
 */
class SettlementCheckAddressHintRenderer extends CustomizableClass
{
...
HTML;
    ...
    {
        $key = Constants\UserDetail::PL_USER_BILLING_ADDRESS;
