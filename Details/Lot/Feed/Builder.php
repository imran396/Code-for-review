<?php
/**
 * Lot Feed output builder. Main module
 *
...
class Builder extends \Sam\Details\Core\Feed\Builder
{
    ...
    protected function initOptions(): void
    {
        ...
        $this->options->itemsPerPage = $this->getFeed()->ItemsPerPage > 0
            ? $this->getFeed()->ItemsPerPage
            : $this->cfg()->get('core->feed->itemsPerPage');
        $this->options->isIncludeInReports = $this->getFeed()->IncludeInReports;
