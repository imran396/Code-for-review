<?php
/**
 * Special to lot Seo Url template parser
 *
 ...
 * @package Sam\Details
 */
class TemplateParser extends \Sam\Details\Lot\Base\Render\TemplateParser
{
    ...
    public function parse(string $template, ?array $placeholders, array $row): string
    {
        ...
        return $textTransformer->cut($output, $this->cfg()->get('core->lot->seoUrl->lengthLimit'));
    }
}
