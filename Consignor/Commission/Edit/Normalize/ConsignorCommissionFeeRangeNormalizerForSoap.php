...
/**
 * This class contains methods for normalizing consignor commission fee range input data to be validated and persisted for SOAP input mode
 *
 * Class ConsignorCommissionRangeDtoNormalizer
 * @package Sam\Consignor\Commission\Edit
 */
class ConsignorCommissionFeeRangeNormalizerForSoap extends CustomizableClass implements ConsignorCommissionFeeRangeNormalizerInterface
{
    ...
    public function normalizeMode(string|int $value): int
    {
        ...
        $normalizedValue = array_search($value, Constants\ConsignorCommissionFee::RANGE_MODE_SOAP_NAMES, true);
