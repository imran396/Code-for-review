 ...
 */
abstract class CancelEnterBidderNumber extends CommandBase implements RtbCommandHelperAwareInterface
{
    ...
    public function execute(): void
    {
        ...
        $rtbCurrent = $this->getRtbCommandHelper()->activateLot($rtbCurrent, Constants\Rtb::LA_STARTED, $this->detectModifierUserId());  // SAM-970
        ...
        $this->langStatus = sprintf($this->translate('BIDDERCLIENT_LOTREOPENED'), $lotNo);

        $this->getLogger()->log("Admin reopened lot to bidder");
