...
/**
 * Class ViewerLiveController
 */
class ViewerLiveController extends ControllerBase
{
    /** @var string[] */
    ...
    /**
     * Get a ViewerLiveController instance
     * @return static
     */
    ...
    protected function sync(object $data): array
    {
        ...
        $viewerResourceId = $paramFetcher->getInt(Constants\Rtb::REQ_VIEWER_RESOURCE_ID);
        $command = Sync::new();
        /** @var Sync $command */
