...
use Sam\Rtb\Command\Concrete\Hybrid\AcceptLotChanges;
use Sam\Rtb\Command\Concrete\Hybrid\DropInterest;
use Sam\Rtb\Command\Concrete\Hybrid\Interest;
use Sam\Rtb\Command\Concrete\Hybrid\PlaceBid;
...
/**
 * Class BidderHybridController
 */
class BidderHybridController extends ControllerBase
{
    ...
    /**
     * TODO: rename to initHandler() or initCommandHandler()
    ...
    protected function sellLots(object $data): array
    {
        ...
        $handler = SellLotsHybridBidderHandler::new()->construct($command);
        /** @var SellLotsHybridBidderHandler $handler */
