 ...
 */
class AuctioneerController extends ControllerBase
{
    /** @var string[] */
    ...
    /**
     * Get a AuctioneerController instance
     * @return static
     */
    ...
    protected function initCommand(CommandBase $command, object $data): CommandBase
    {
        ...
        $command->setUserType(Constants\Rtb::UT_AUCTIONEER);
        return $command;
    }
    ...
    protected function sendMessage(object $data): array
    {
        ...
        $command->setBidderNo($paramFetcher->getString(Constants\Rtb::REQ_RECEIVER_BIDDER_NO));
        $command->execute();
        $responses = $command->getResponses();
        return $responses;
    }
     ...
     */
    public function syncInterest(object $data): array
    {
