...
use Sam\Rtb\Command\Concrete\Live\BuyNow;
use Sam\Rtb\Command\Concrete\Live\LinkRtbd;
use Sam\Rtb\Command\Concrete\Live\Resync;

/**
 * Class ClientLiveController
 */
class ClientLiveController extends ControllerBase
{
    /** @var string[] */
