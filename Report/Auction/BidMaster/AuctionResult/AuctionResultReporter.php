...
namespace Sam\Report\Auction\BidMaster\AuctionResult;
 ...
 */
class AuctionResultReporter extends ReporterBase
{
    ...
    protected function outputBody(): string
    {
        ...
        foreach ($auctionLotGenerator as $auctionLot) {
            ...
            if ($auctionLotCache) {
                ...
                log_error(
                    'Available auction lot cache not found, when rendering auction result report'
