 ...
 */
class LiveLotImportSampler extends LotImportSamplerBase
{
    protected ?string $outputFileName = 'live-items.csv';
    ...
    {
        $this->setTitles($this->cfg()->get('csv->admin->live')->toArray());
        $this->sendHttpHeader();
        $this->outputContent();
        return '';
    }
    ...
    {
        $this->sampleValues[Constants\Csv\Lot::ITEM_NUM] = ['766687', '766688', '766689'];
