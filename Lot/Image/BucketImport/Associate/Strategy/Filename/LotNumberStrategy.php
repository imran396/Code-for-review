...
/**
 * Class AssociateByLotNumberStrategy
 * @package Sam\Lot\Image\BucketImport\Associate\Strategy
 */
class LotNumberStrategy extends FilenameStrategyBase
{
    ...
    {
        return $this->createFilenamePatternAssociationLotLoader()->loadByLotNumber($search, $auctionId);
    }
}
