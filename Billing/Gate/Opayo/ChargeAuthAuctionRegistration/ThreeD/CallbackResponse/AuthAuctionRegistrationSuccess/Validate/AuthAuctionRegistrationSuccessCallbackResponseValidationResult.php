...
class AuthAuctionRegistrationSuccessCallbackResponseValidationResult extends CustomizableClass
{
    ...
    public const ERR_INVALID_OPAYO_AUTH_TYPE = 6;
    public const ERR_INVALID_VTX = 7;
