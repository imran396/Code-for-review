...
class AdminInvoiceSuccessCallbackResponseValidationResult extends CustomizableClass
{
    ...
    public const ERR_INVALID_USER_ID = 4;
    public const ERR_INVALID_INVOICE_ID = 5;
    public const ERR_INVALID_CC_NUMBER = 6;
    public const ERR_INVALID_AMOUNT = 7;
    public const ERR_EDITOR_USER_NOT_FOUND = 8;
