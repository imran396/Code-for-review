...
use Sam\Billing\Gate\Opayo\ChargeAuthAccountRegistration\ThreeD\CallbackResponse\AuthAccountRegistrationSuccess\Validate\AuthAccountRegistrationSuccessCallbackResponseValidationResult as Result;
use Sam\Core\Constants\BillingOpayo;
use Sam\Core\Math\Floating;
use Sam\Core\Service\CustomizableClass;


class AuthAccountRegistrationSuccessCallbackResponseValidator extends CustomizableClass
{
    ...
    {
        if ($result->hasError()) {
            log_error("Input validation failed for auth account registration  " . composeSuffix($result->logData()));
        }
    }
}
