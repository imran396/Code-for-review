...
trait RedirectUrlBuilderCreateTrait
{
    ...
    /**
     * @param RedirectUrlBuilder $builder
     * @return static
     * @internal
     */
    public function setRedirectUrlBuilder(RedirectUrlBuilder $builder): static
    {
        $this->redirectUrlBuilder = $builder;
        return $this;
    }
}
