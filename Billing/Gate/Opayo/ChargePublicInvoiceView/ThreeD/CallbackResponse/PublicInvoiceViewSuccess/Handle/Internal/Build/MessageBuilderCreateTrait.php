...
trait MessageBuilderCreateTrait
{
     ...
     */
    protected ?MessageBuilder $messageBuilder = null;
    ...
    {
        return $this->messageBuilder ?: MessageBuilder::new();
    }
     ...
     * @internal
     */
    public function setMessageBuilder(MessageBuilder $builder): static
    {
