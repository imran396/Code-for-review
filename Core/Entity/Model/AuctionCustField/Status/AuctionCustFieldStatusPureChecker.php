...
namespace Sam\Core\Entity\Model\AuctionCustField\Status;

use Sam\Core\CustomField\Status\CustomFieldStatusPureChecker;
use Sam\Core\Service\CustomizableClass;

/**
 * Class AuctionCustFieldStatusPureChecker
 * @package Sam\Core\Entity\Model\AuctionCustField\Status
 */
class AuctionCustFieldStatusPureChecker extends CustomizableClass
{
    /**
