...
namespace Sam\Core\Entity\Model\UserCustField\Status;

use Sam\Core\CustomField\Status\CustomFieldStatusPureChecker;
use Sam\Core\Service\CustomizableClass;

/**
 * Class UserCustFieldStatusPureChecker
 * @package Sam\Core\Entity\Model\UserCustField\Status
 */
class UserCustFieldStatusPureChecker extends CustomizableClass
{
    /**
