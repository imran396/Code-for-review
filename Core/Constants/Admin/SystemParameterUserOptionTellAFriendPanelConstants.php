...
/**
 * Class SystemParameterUserOptionTellAFriendPanelConstants
 */
class SystemParameterUserOptionTellAFriendPanelConstants
{
    public const CID_CHK_TELL_A_FRIDAY = 'uof22';
    public const CID_CHK_ANYONE_TELL_A_FRIEND = 'uof23';

    public const PANEL_TO_PROPERTY_MAP = [
        self::CID_CHK_TELL_A_FRIDAY => Constants\Setting::TELL_A_FRIEND,
        self::CID_CHK_ANYONE_TELL_A_FRIEND => Constants\Setting::ALLOW_ANYONE_TO_TELL_A_FRIEND,
    ];
}
