...
/**
 * Class SystemParameterSystemSystemEmailAddressPanelConstants
 */
class SystemParameterSystemSystemEmailAddressPanelConstants
{
    public const CID_TXT_SUPPORT_EMAIL = 'scf2';

    public const PANEL_TO_PROPERTY_MAP = [
        self::CID_TXT_SUPPORT_EMAIL => Constants\Setting::SUPPORT_EMAIL
    ];
}
