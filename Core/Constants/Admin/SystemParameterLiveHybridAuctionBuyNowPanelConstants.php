...
/**
 * Class SystemParameterLiveHybridAuctionBuyNowPanelConstants
 */
class SystemParameterLiveHybridAuctionBuyNowPanelConstants
{
    public const CID_RAD_BUY_NOW_RESTRICTION = 'apf121';
    public const CID_CHK_BUY_NOW_UNSOLD = 'apf122';

    public const PANEL_TO_PROPERTY_MAP = [
        self::CID_RAD_BUY_NOW_RESTRICTION => Constants\Setting::BUY_NOW_RESTRICTION,
        self::CID_CHK_BUY_NOW_UNSOLD => Constants\Setting::BUY_NOW_UNSOLD,
    ];
}
