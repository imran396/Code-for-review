...
/**
 * Class SystemParameterLayoutAndSiteCustomizationNumberFormattingPanelConstants
 */
class SystemParameterLayoutAndSiteCustomizationNumberFormattingPanelConstants
{
    public const CID_CHK_US_NUM_FORMATTING = 'scf35';
    public const CID_CHK_KEEP_DECIMAL = 'scf58';

    public const PANEL_TO_PROPERTY_MAP = [
        self::CID_CHK_US_NUM_FORMATTING => Constants\Setting::US_NUMBER_FORMATTING,
        self::CID_CHK_KEEP_DECIMAL => Constants\Setting::KEEP_DECIMAL_INVOICE,
    ];
}
