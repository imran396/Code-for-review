...
/**
 * Class CategoriesFieldResolver
 * @package Sam\Api\GraphQL\Type\Query\Resolve\ItemType
 */
class CategoriesFieldResolver extends CustomizableClass implements FieldResolverInterface
{
    /**
    ...
    public function resolve(array $objectValue, array $args, AppContext $appContext, ResolveInfo $info): Promise
    {
        ...
        return $appContext->dataLoader->loadLotItemCategories($lotItemId);
    }
}
