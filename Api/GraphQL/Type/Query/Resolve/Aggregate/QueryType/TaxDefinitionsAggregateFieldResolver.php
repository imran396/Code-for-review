...
/**
 * Class TaxDefinitionsAggregateFieldResolver
 * @package Sam\Api\GraphQL\Type\Query\Resolve\Aggregate\QueryType
 */
class TaxDefinitionsAggregateFieldResolver extends CustomizableClass implements AggregateFieldResolverInterface
{
    ...
    public function resolve(array $objectValue, array $args, AppContext $appContext, ResolveInfo $info): array
    {
        ...
        $result = TaxDefinitionDataLoader::new()->aggregate(
