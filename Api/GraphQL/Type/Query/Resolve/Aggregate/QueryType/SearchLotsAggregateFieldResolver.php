...
/**
 * Class SearchLotsAggregateFieldResolver
 * @package Sam\Api\GraphQL\Type\Query\Resolve\Aggregate\QueryType
 */
class SearchLotsAggregateFieldResolver extends CustomizableClass implements AggregateFieldResolverInterface
{
    ...
    public function resolve(array $objectValue, array $args, AppContext $appContext, ResolveInfo $info): array
    {
        ...
        $result = LotDataLoader::new()->aggregateForSearch(
