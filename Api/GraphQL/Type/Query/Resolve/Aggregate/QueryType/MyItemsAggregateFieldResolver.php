...
/**
 * Class MyItemsAggregateFieldResolver
 * @package Sam\Api\GraphQL\Type\Query\Resolve\Aggregate\QueryType
 */
class MyItemsAggregateFieldResolver extends CustomizableClass implements AggregateFieldResolverInterface
{
    ...
    public function resolve(array $objectValue, array $args, AppContext $appContext, ResolveInfo $info): array
    {
        ...
        $result = LotDataLoader::new()->aggregateForMyItems(
