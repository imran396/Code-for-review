...
/**
 * Class AuctioneersFieldResolver
 * @package Sam\Api\GraphQL\Type\Query\Resolve\QueryType
 */
class AuctioneersFieldResolver extends CustomizableClass implements FieldResolverInterface
{
    /**
    ...
    {
        return $appContext->dataLoader->loadAuctioneers();
    }
}
