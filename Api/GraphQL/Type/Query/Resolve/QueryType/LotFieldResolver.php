...
/**
 * Class LotFieldResolver
 * @package Sam\Api\GraphQL\Type\Query\Resolve\QueryType\Internal
 */
class LotFieldResolver extends CustomizableClass implements FieldResolverInterface
{
    /**
    ...
    {
        return $appContext->dataLoader->loadAuctionLot($args['lotItemId'], $args['auctionId']);
    }
}
