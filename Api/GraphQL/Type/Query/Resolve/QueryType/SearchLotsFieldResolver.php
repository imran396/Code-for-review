...
/**
 * Class SearchLotsFieldResolver
 * @package Sam\Api\GraphQL\Type\Query\Resolve\QueryType
 */
class SearchLotsFieldResolver extends CustomizableClass implements FieldResolverInterface
{
    /**
    ...
    public function resolve(array $objectValue, array $args, AppContext $appContext, ResolveInfo $info): Deferred
    {
        ...
        return $appContext->dataLoader->loadLotsForSearch(
