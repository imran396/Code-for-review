...
/**
 * Class IdFieldResolver
 * @package Sam\Api\GraphQL\Type\Query\Resolve\LotType
 */
class IdFieldResolver extends CustomizableClass implements FieldResolverInterface
{
    /**
    ...
    public function resolve(array $objectValue, array $args, AppContext $appContext, ResolveInfo $info): int
    {
        return (int)$objectValue['alid'];
    }
}
