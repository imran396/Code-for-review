...
/**
 * Class LotListPostalCodeCustomFieldFilterType
 * @package Sam\Api\GraphQL\Type\Query\Definition\Lot\Filter\Internal\Type
 */
class LotListPostalCodeCustomFieldFilterType extends CustomizableClass implements TypeInterface
{
    public const NAME = 'LotListPostalCodeCustomFieldFilter';
    ...
    public function createTypeDefinition(): InputObjectType
    {
        return new InputObjectType([
            'name' => self::NAME,
            'fields' => [
                'postalCode' => new NonNull(Type::string()),
                'radius' => new NonNull(Type::int()),
            ]
        ]);
    }
}
