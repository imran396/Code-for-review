...
/**
 * Class LotListMyItemsFilterType
 * @package Sam\Api\GraphQL\Type\Query\Definition\Lot\Filter
 */
class LotListMyItemsFilterType extends CustomizableClass implements TypeInterface, AppContextAwareInterface, TypeRegistryAwareInterface
{
    use AppContextAwareTrait;
    use FilterFieldConfigurationFactoryCreateTrait;
    use TypeRegistryAwareTrait;

    public const NAME = 'LotListMyItemsFilter';
