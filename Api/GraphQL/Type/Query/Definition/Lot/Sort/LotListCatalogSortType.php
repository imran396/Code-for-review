...
/**
 * Class LotListCatalogSortType
 * @package Sam\Api\GraphQL\Type\Query\Definition\Lot\Sort
 */
class LotListCatalogSortType extends CustomizableClass implements TypeInterface, AppContextAwareInterface
{
    use AppContextAwareTrait;
    use SortFieldConfigurationFactoryCreateTrait;

    public const NAME = 'LotListCatalogSort';
