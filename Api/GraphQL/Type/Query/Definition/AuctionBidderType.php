...
/**
 * Class AuctionBidderType
 * @package Sam\Api\GraphQL\Type
 */
class AuctionBidderType extends CustomizableClass implements TypeInterface
{
    public const NAME = 'AuctionBidder';
    ...
    public function createTypeDefinition(): ObjectType
    {
        return new ObjectType(
            [
                ...
                'fields' => [
                    'id' => Type::id(),
                    'bidder_num' => Type::string(),
                    'spent' => Type::float(),
                    'collected' => Type::float(),
                ]
            ]
        );
    }
