...
/**
 * Class TaxSchemaValidationResult
 * @package Sam\Tax\StackedTax\Schema\Edit\Validate
 */
class TaxSchemaValidationResult extends CustomizableClass
{
    use ResultStatusCollectorAwareTrait;

    public const ERR_NAME_REQUIRED = 1;
    public const ERR_NAME_EXISTS = 2;
    public const ERR_GEO_TYPE_INVALID = 3;
    public const ERR_COUNTRY_REQUIRED = 4;
    public const ERR_COUNTRY_INVALID = 5;
    public const ERR_COUNTRY_NOT_ALLOWED = 6;
    public const ERR_STATE_REQUIRED = 7;
    public const ERR_STATE_NOT_ALLOWED = 8;
    public const ERR_COUNTY_REQUIRED = 9;
    public const ERR_COUNTY_NOT_ALLOWED = 10;
    public const ERR_CITY_REQUIRED = 11;
    public const ERR_CITY_NOT_ALLOWED = 12;
    public const ERR_TAX_SCHEMA_NOT_FOUND = 13;
    public const ERR_AMOUNT_SOURCE_INVALID = 14;
    ...
    protected const ERROR_MESSAGES = [
        ...
        self::ERR_TAX_SCHEMA_NOT_FOUND => 'Tax schema not found',
        self::ERR_AMOUNT_SOURCE_INVALID => 'Amount source invalid'
    ];
