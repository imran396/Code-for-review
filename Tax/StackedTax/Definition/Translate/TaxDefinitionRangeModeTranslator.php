...
/**
 * Class TaxDefinitionRangeModeTranslator
 * @package Sam\Tax\StackedTax\Definition\Translate
 */
class TaxDefinitionRangeModeTranslator extends CustomizableClass
{
    ...
    public function trans(string $mode): string
    {
        $translation = '';
        $key = Constants\StackedTax::RANGE_MODE_TRANSLATIONS[$mode] ?? null;
        if ($key) {
